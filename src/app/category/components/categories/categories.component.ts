...
export class CategoriesComponent implements OnInit {
  ...
  categoriesData = {
    'title': 'Home Service',
    'images': [
        'http://s8.staging-host.com/xpbid/images/category3.png',
        'http://s8.staging-host.com/xpbid/images/category2.png',
        'http://s8.staging-host.com/xpbid/images/category1.png',
      ],
    'description': `<p>
  ...
  <p>
  <em>Temporibus autem quibusdam et aut officiis debitis aut rerum
